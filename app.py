...
def consultar_empresa_foco(
    ...
    usando APENAS o snapshot de data_ref (partição diária via decorator).
    """
    if not data_ref:
...
def consultar_socios_foco(
    ...
    SOMENTE no snapshot indicado por data_ref (partição diária via decorator),
